...
const projectList = [
    ...
    {
        title: "LokiGram-Social Media Web App",
        description: "A social media platform build using MERN stack with CRUD",
        tech: ["Reactjs", "Scss", "Framer Motion", "Socket"],
        link: "https://lokigram.netlify.app/",
        codeLink: "https://github.com/iloki-codes/Social-Media-App",
        img: ""
    },
];
...
const Projects = () => {
  ...
  return (
    ...
    <section className="py-16" data-aos="fade-up">
        ...
        <h2 className="text-3xl sm:text-4xl font-bold text-cyan-400 text-center mb-15 border-lime-200">
            Projects I've Built
        </h2>
        ...
        <div className="grid md:grid-cols-1 lg:grid-cols-2 gap-8 px-4">

            {
                projectList.map((project, i) => (
                    <div
                        key={i}
                        className="group bg-linear-to-br from-zinc-600 via-yellow-950 to-lime-100 rounded-2xl shadow-lg p-6 hover:shadow-3xl hover:scale-[1.02] transition-all h-auto w-auto"
                    >
                        <h3 className="text-xl font-semibold mb-2 text-lime-200 hover:cursor-pointer">
                        ...
                        <aside className="flex flex-row no-wrap gap-4">
                            ...
                            <a href={project.link} className="hover:cursor-pointer rounded-xl">
                                <img src={project.img} className="rounded-xl h-[8vw] w-[15vw]" alt={project.img} loading="lazy" />
                            </a>
                        </aside>
