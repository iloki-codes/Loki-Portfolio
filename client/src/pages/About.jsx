    ...
    <div className='relative flex flex-row justify-betweeb=n flex-wrap gap-10'>
      ...
      <section className='p-[50px] h-auto w-1/2 bg-linear-to-b from-emerald-950 via-yellow-800 to-emerald-900 relative backdrop-blur-md mt-10 border-1 flex flex-col items-center shadow-lg rounded-xl '>
        ...
        <p className="text-[#f5deb3]">
          ...
          <span className="text-[#f5deb3]">I would describe myself as an introverted person who is always eager to learn. I'm constantly seeking knowledge about things that interest me. I value collaboration and thrive in team environments despite its challenges.</span><br/><br />
          ...
          <SendHorizonal className='inline text-[#ffd700]'/> <span className='text-[#ffd700]'>Let's Connect:</span> If you're looking for a MERN developer who can grow with your team and deliver high-quality code from day one- I'd love to connect!
